...
export default function Modal(props) {
    ...
    return(
        <>     
            {            
                isOpen ? (
                    <section className="w-screen h-screen  flex justify-center items-center fixed inset-0 z-40 text-white" >
                        <div className="absolute inset-0 bg-black/20" onClick={funct}>
